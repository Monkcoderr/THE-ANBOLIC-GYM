...
/**
 * Normalize an admin-entered custom member ID. Trims surrounding whitespace and
 * collapses an empty value to `undefined` so the sparse unique index treats the
 * member as "no ID assigned" rather than clashing on an empty string.
 */
